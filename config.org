...
*** Python
Run the following install first
#+BEGIN_SRC shell
pip3 install --user jedi flake8 autopep8 yapf
#+END_SRC
Install =elpy=
#+BEGIN_SRC elisp
  (use-package elpy
...
#+END_SRC
I need org-agenda to tell me my TODOs from =index.org, journal.org= and =physics-journal.org=
#+BEGIN_SRC emacs-lisp
  (setq fiddler/org-agenda-files (list org-index-file
                                       org-idea-file
                                       org-projects-file
                                       (org-file-path "journal.org")
                                       (org-file-path "physics-journal.org")))
  (setq org-agenda-files fiddler/org-agenda-files)
#+END_SRC
...
- Journal template
  #+BEGIN_SRC emacs-lisp
    (add-to-list 'org-capture-templates '("j" "Journal Entry"
                                          ...
                                          "** %U %^{Title}\n%?"))
  #+END_SRC
- Project Elective Journal
  #+BEGIN_SRC emacs-lisp
    (add-to-list 'org-capture-templates '("J" "OCR Consensus Project Journal"
                                          entry
                                          (file+olp+datetree "journal.org")
                                          "** %U %^{Title}\n%?"))
  #+END_SRC
